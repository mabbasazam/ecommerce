...
import { Menu, MenuItem, Avatar } from "@mui/material"; // Added Avatar
import { useNavigate } from "react-router-dom";
import AuthModal from "../../../Auth/AuthModal";
import { useSelector, useDispatch } from "react-redux";
import { logout, fetchUserProfile } from "../../../store/authSlice"; // Adjust path based on your structure
        ...
        <div className="fixed inset-0 z-40 flex">
          ...
          >
            ...
            <TabGroup className="mt-2">
              ...
              <TabPanels as="div">
                {" "}
                {/* Changed from as={Fragment} to as="div" */}
                {navigation.categories.map((category) => (
                  <TabPanel
                    key={category.name}
